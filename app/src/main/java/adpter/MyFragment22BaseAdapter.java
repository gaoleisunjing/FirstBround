 ...
 */
public class MyFragment22BaseAdapter extends BaseAdapter {

    List<Tour.ListBean> listBeen;
    Context context;

    public MyFragment22BaseAdapter(List<Tour.ListBean> listBeen, Context context) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            view = LayoutInflater.from(context).inflate(R.layout.item_fragment22adapter, null);

            holderView.imageView1 = (ImageView) view.findViewById(R.id.fragment22Image1Id);
            holderView.textView1 = (TextView) view.findViewById(R.id.fragment22TextView1Id);
