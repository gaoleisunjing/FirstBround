 ...
 */
public class MyFragment24BaseAdapter extends BaseAdapter {

    List<Shuma.ListBean> listBeen;
    Context context;

    public MyFragment24BaseAdapter(List<Shuma.ListBean> listBeen, Context context) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            view = LayoutInflater.from(context).inflate(R.layout.item_fragment24adapter, null);

            holderView.imageView1 = (ImageView) view.findViewById(R.id.fragment24Image1Id);
            holderView.textView1 = (TextView) view.findViewById(R.id.fragment24TextView1Id);
