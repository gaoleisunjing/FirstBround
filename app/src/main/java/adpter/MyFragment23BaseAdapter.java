 ...
 */
public class MyFragment23BaseAdapter extends BaseAdapter {

    List<Environment.ListBean> listBeen;
    Context context;

    public MyFragment23BaseAdapter(List<Environment.ListBean> listBeen, Context context) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            view = LayoutInflater.from(context).inflate(R.layout.item_fragment23adapter, null);

            holderView.imageView1 = (ImageView) view.findViewById(R.id.fragment23Image1Id);
            holderView.textView1 = (TextView) view.findViewById(R.id.fragment23TextView1Id);
