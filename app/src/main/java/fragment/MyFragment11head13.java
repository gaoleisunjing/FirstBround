 ...
 */
public class MyFragment11head13 extends Fragment {
    ...
    public MyFragment11head13 getFragment() {
        MyFragment11head13 myFragment11head1 = new MyFragment11head13();
        //有参数的话可以用来传值
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                Gson gson = new Gson();
                Type type = new TypeToken<ArrayList<Title1>>() {
                }.getType();
                ...
                handler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Log.d("gl", "=========text3的title" + title);
                        Picasso.with(getActivity()).load(list.get(2).getPic_src()).error(R.mipmap.ic_launcher).into(imageView);
