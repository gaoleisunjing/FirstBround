 ...
 */
public class MyFragment11head1 extends Fragment {
    ...
    public MyFragment11head1 getFragment() {
        MyFragment11head1 myFragment11head1 = new MyFragment11head1();
        //有参数的话可以用来传值
            ...
            public void run() {
                ...
                handler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Log.d("gl", "=========text1的title" + title);
                        Picasso.with(getActivity()).load(list.get(0).getPic_src()).error(R.mipmap.ic_launcher).into(imageView);
